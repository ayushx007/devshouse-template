            ...
            <div className='flex max-h-[45vh] mt-24 max-md:scale-[0.6] max-md:-mt-12 scale-150 max-2xl:scale-90 max-sm:scale-50'>
                <div className='first-letter:' style={{ transform: 'rotateX(0deg) rotateY(0deg) rotateZ(0deg) translate3d(45vw, 0px, 0px) skew(0deg, 0deg) ' }}>
                    <div className='flex justify-center items-center w-80'>
                        <Cube size={100} image={'../../assets/prev1.jpeg'} bgColor='#0D9C58' borderColor='#59CE95' />
                        <Cube size={100} image={'../../assets/prev2.jpeg'} style={{ marginTop: '80px', marginLeft: '-65px' }} bgColor='#0D9C58' borderColor='#59CE95' />
                    ...
                    <div className='flex justify-center items-center w-64' style={{ transform: 'rotateX(0deg) rotateY(180deg) rotateZ(0deg)  translate3d(260px, 0px, 100px) skew(0deg, 0deg)' }}>
                        ...
                        <Cube size={100} image={'../../assets/prev5.jpeg'} style={{ marginTop: '80px', marginLeft: '-65px' }} bgColor='#FBBC08' borderColor='#FFD764' x={-310} y={-5} />
                    </div>
                    <div className='flex justify-center items-center w-80' style={{ transform: 'rotateX(0deg) rotateY(180deg) rotateZ(0deg)  translate3d(100px, 0px, 100px) skew(0deg, 0deg)' }}>
                        <Cube size={100} image={'../../assets/prev10.jpeg'} bgColor='#EA4335' borderColor='#FF7266' x={-1205} y={-2200} z={-1215} />
                        <Cube size={100} image={'../../assets/prev9.jpeg'} style={{ marginTop: '80px', marginLeft: '-65px' }} bgColor='#EA4335' borderColor='#FF7266' x={-1205} y={-2200} z={-1215} />
                        <Cube size={100} image={'../../assets/prev8.jpeg'} style={{ marginTop: '160px', marginLeft: '-65px' }} bgColor='#EA4335' borderColor='#FF7266' x={-1205} y={-2200} z={-1215} />
                    </div>
                    <div className='flex justify-center items-center w-64'>
                        <Cube size={100} image={'../../assets/prev7.jpeg'} bgColor='#4285F4' borderColor='#81B0FF' x={-800} y={-825} z={-130} />
                        <Cube size={100} image={'../../assets/prev6.jpeg'} style={{ marginTop: '80px', marginLeft: '-65px' }} bgColor='#4285F4' borderColor='#81B0FF' x={-800} y={-825} z={-130} />
                    </div>
                </div>
            </div>
            <div className='flex'>
