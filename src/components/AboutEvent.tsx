	...
	return (
		<div className="mx-16">
			<div className="flex my-4 gap-2">
                ...
                <p className="rounded-md border-2 border-[#5392F6] text-xs py-0.5 px-2 text-[#5392F6]">Experiment</p>
			</div>
			<div className="bg-[#F3F6FC] px-8 py-2 rounded-lg">
				<img src="\assets\gif.png" alt="bard Gif" className="h-6"/>
				<p className="font-bold text-2xl ">Hello again! DevMania ‘24</p>
				<p className="p-4 text-neutral-500 text-sm font-medium">
				...
				<div className="grid grid-cols-3 gap-6 mb-2">
					<div className="bg-white rounded-xl p-4">
						...
						<p className="bg-[#F3F6FC] py-2 px-4  mb-2 rounded-full w-fit font-medium">
							Ideathon
						</p>
						<p className="bg-[#F3F6FC] py-2 px-4  mb-2 rounded-full w-fit font-medium">
							innovative Thinking
						</p>
						<p className="bg-[#F3F6FC] py-2 px-4   rounded-full w-fit font-medium">
							Conceptualization
						</p>
					</div>
					<div className="bg-white rounded-xl p-4">
				...
				<div className="py-2 flex mb-2">
					<div className="w-full bg-white text-sm py-2 px-4 rounded-full mx-6 text-neutral-500 border-2 border-black flex justify-between">
						<p className="ml-4">Why is DevMania the go-to hackathon event?</p>
